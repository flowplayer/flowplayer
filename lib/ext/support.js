...
(function() {
   ...
   var video = createVideoTag(),
      ...
      IS_IPHONE_VER = IS_IPHONE ? parseFloat(/iP(hone|od) OS (\d+)/.exec(UA)[2], 10) : 0,
      ...
      s = extend(flowplayer.support, {
        ...
        inlineVideo: IS_IPHONE_VER >= 10 || !IS_IPHONE && (!IS_WP || (WP_VER >= 8.1 && IE_MOBILE_VER >= 11)) && (!IS_ANDROID || ANDROID_VER >= 3),
