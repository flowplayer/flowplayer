...
(function() {
   ...
   var video = createVideoTag(),
      ...
      s = extend(flowplayer.support, {
        ...
        firstframe: !IS_SILK && !IS_WP && !IS_ANDROID_FIREFOX && !(IOS_VER && IOS_VER < 10) && !(IS_ANDROID && b.chrome && ANDROID_VER < 4.4),
        mutedAutoplay: (IS_IPHONE || IS_IPAD || IS_IPAD_CHROME) && IOS_VER >=10 || (IS_ANDROID && b.chrome) && ANDROID_VER > 4.3,
