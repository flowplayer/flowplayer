...
$(document).bind("keydown.fp", function(e) {
   ...
   if (key == 27) {
      ...
      if (el.conf.splash) { el.unload(); return false; }
   }
   ...
   if (!metaKeyPressed && el.ready) {
      ...
      switch (key) {
         ...
         case 70: window == window.top && el.fullscreen(); break;          // toggle fullscreen
         case 77: el.mute(); break;                                        // mute
         case 27: if (el.isFullscreen) el.fullscreen(false); break;        // esc
      }
