      ...
      if (FS_SUPPORT) {
         ...
         if (flag) {
            if (FS_NATIVE_SUPPORT) {
               ...
               if (!document.webkitCurrentFullScreenElement || !document.mozFullScreenElement) { // Element.ALLOW_KEYBOARD_INPUT not allowed
                  root.removeClass('is-fullscreen'); // Didn't enter fullscreen but triggered event..
