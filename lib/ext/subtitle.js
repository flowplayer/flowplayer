...
flowplayer(function(p, root) {
  ...
  var createSubtitleControl = function() {
    subtitleControl = common.createElement('a', {className: 'fp-menu fp-subtitle-menu'});
  ...
  bean.on(root, 'click', '.fp-subtitle-menu', function() {
    common.toggleClass(subtitleControl, 'fp-active');
  });

  bean.on(root, 'click', '.fp-subtitle-menu li[data-subtitle-index]', function(ev) {
