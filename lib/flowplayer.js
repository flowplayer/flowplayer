...
$.extend(flowplayer, {
   ...
   defaults: {
      ...
      volume: typeof localStorage == "object" ? localStorage.volume || 1 : 1,
...
$.fn.flowplayer = function(opts, callback) {
   ...
   return !opts && this.data("flowplayer") || this.each(function() {
      ...
      if (this.currentStyle && this.currentStyle['direction'] === 'rtl')
         root.addClass('is-rtl');
      else if (window.getComputedStyle && window.getComputedStyle(this, null).getPropertyValue('direction') === 'rtl')
         root.addClass('is-rtl');
