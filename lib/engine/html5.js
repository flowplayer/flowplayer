...
flowplayer.engine.html5 = function(player, root) {
   ...
   function listen(api) {
      ...
      // video file not found, try 3 seconds
      videoFoundTimer = setTimeout(function() {
         if (!videoFound && conf.preload != "none") {
            return root.trigger("error", [player, { code: 4 }])
         }
      }, conf.timeout);
