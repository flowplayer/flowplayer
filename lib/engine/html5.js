          ...
          if (!e.target || !common.hasClass(e.target, 'fp-engine')) return;
            ...
            switch (flow) {
               ...
               case "ready":
                  ...
                  try {
                     arg.seekable = /mpegurl/i.test(video ? (video.type || '') : '') && api.duration || api.seekable.length && api.seekable.end(null) || player.live;
                  ...
                  timer = timer || setInterval(function() {
                     ...
                     try {
                        arg.buffer = api.buffered.length && api.buffered.end(null);
                  ...
                  if (!player.live && !arg.duration && !support.hlsDuration && type === "loadeddata") {
                     var durationChanged = function() {
                        ...
                        try {
                           arg.seekable = api.seekable.length && api.seekable.end(null);
